...
public static class DapperDataContext
{
    private const string Sql = @"
        ...
        CREATE TABLE IF NOT EXISTS VolumeInfos (
            ...
            CONSTRAINT FK_VolumeInfos_Snapshots_SnapshotId FOREIGN KEY (SnapshotId)    REFERENCES Snapshots (Id) ON DELETE CASCADE
        );
        ...
        CREATE TABLE IF NOT EXISTS PcsToStorageDrives (
            ...
            CONSTRAINT FK_PcsToStorageDrives_Pcs_PcId                     FOREIGN KEY (PcId)            REFERENCES Pcs (Id)           ON DELETE CASCADE,
            CONSTRAINT FK_PcsToStorageDrives_StorageDrives_StorageDriveId FOREIGN KEY (StorageDriveId)  REFERENCES StorageDrives (Id) ON DELETE CASCADE,
            CONSTRAINT FK_PcsToStorageDrives_Snapshots_SnapshotId         FOREIGN KEY (SnapshotId)      REFERENCES Snapshots (Id)     ON DELETE CASCADE
        );
        ...
        CREATE TABLE IF NOT EXISTS FoldersToFolders (
            ...
            CONSTRAINT FK_FoldersToFolders_Snapshots_SnapshotId FOREIGN KEY (SnapshotId)     REFERENCES Snapshots (Id) ON DELETE CASCADE,
            CONSTRAINT FK_FoldersToFolders_Folders_FolderId     FOREIGN KEY (ParentFolderId) REFERENCES Folders (Id)   ON DELETE CASCADE,
            CONSTRAINT FK_FoldersToFolders_Folders_FolderId     FOREIGN KEY (ChildFolderId)  REFERENCES Folders (Id)   ON DELETE CASCADE
        );
        ...
        CREATE TABLE IF NOT EXISTS FilesToFolders (
            ...
            CONSTRAINT FK_FilesToFolders_Folders_FolderId      FOREIGN KEY (FolderId)    REFERENCES Folders (Id)   ON DELETE CASCADE,
            CONSTRAINT FK_FilesToFolders_Files_FileId          FOREIGN KEY (FileId)      REFERENCES Files (Id)     ON DELETE CASCADE,
            CONSTRAINT FK_FilesToFolders_Snapshots_SnapshotId  FOREIGN KEY (SnapshotId)  REFERENCES Snapshots (Id) ON DELETE CASCADE
        );
    ";
