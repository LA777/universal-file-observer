...
public class FsFolderEntity : FsItemEntity
{
    ...
    [JsonIgnore]
    public IList<FoldersToFoldersEntity> ChildFolderLinks { get; set; } = [];

    [JsonIgnore]
    public IList<FoldersToFoldersEntity> ParentFolderLinks { get; set; } = [];

    [JsonIgnore]
    public IList<FilesToFoldersEntity> FilesLinks { get; set; } = [];
}
