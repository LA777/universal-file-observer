...
public interface IFileSystemRepository
{
    ...
    public Task<IEnumerable<FsFileEntity>> GetFilesByNameAndExtensionAsync(string name, string extension, Ulid userId, CancellationToken cancellationToken = default); // TODO LA - Consider removing. Not used anywhere.
    public Task<IEnumerable<FsFolderEntity>> GetFoldersByNameAsync(string name, Ulid userId, CancellationToken cancellationToken = default);  // TODO LA - Consider removing. Not used anywhere.
